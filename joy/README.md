...
* autocenter (int, default: 0)
  * Sets the force (between 0 and 100) with which a supported force-feedback steering wheel will be autocentered. 0 disables autocentering; 100 is maximum autocenter force.
